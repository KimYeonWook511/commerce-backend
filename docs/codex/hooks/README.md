...
이 문서 자체가 개별 hook의 운영 규칙을 모두 설명하지는 않는다. 실제 정책, 차단 규칙, 검증 방법은 `docs/codex/hooks/` 아래 개별 문서에서 관리한다.
...
- 개별 hook 정책 문서: `docs/codex/hooks/*.md`
...
- `PreToolUse / Bash`
  ...
  - 정책 문서: `docs/codex/hooks/pre-tool-use-policy.md`
