package com.commerce.payment.legacy.domain.repository;
...
public interface PaymentRepository {
	...
	// backoff 게이트: next_reconcile_at IS NULL이거나 now 이하인 건만 포함.
	...
	// CANCEL 대사 후보: APPROVE 스캔과 동일 cutoff·페이징 정책. UNKNOWN은 staleCutoff(1분), REQUESTED는 requestedStaleCutoff(15분) 기준.
	// backoff 게이트: next_reconcile_at IS NULL이거나 now 이하인 건만 포함.
